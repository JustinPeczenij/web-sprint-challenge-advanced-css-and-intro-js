...
function get20s(arr){
  ...
  for( let i = 0; i < arr.length; i++){
    if(arr[i].includes("1901" && "1959")){
      bornDiedCentury20.push(arr[i])
    }
...
function addArtist(array){
    array.push({id:20, name: "Justin Peczenij", years: "2000 - current day", genre: "Web Design", nationality: "Ukranian American", bio: "This was a really cool guy, he made a lot of things and did a lot of stuff, what a guy this guy was and what a thing this guy did!"})
    return array
  }
